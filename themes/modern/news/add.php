...
<form action="<?php echo $this->urlWithQs ?>" method="post" class="generic-form">
	<table width="100%">
        ...
        <tr>
            <th><label for="news_img"><?php echo htmlspecialchars(Flux::message('CMSNewsLinkLabel')) ?></label></th>
            <td width="100">
                <input type="text" name="news_img" id="news_img" value="<?php echo htmlspecialchars($img) ?>"/>
            </td>
