...
return array(
	'ServerAddress'				=> '147.182.228.120',				// This value is the hostname:port under which Flux runs. (e.g., example.com or example.com:80)
	'BaseURI'					=> '/',						// The base URI is the base web root on which your application lies.
	'InstallerPassword'			=> '96397611',		// Installer/updater password.
	...
	'SiteTitle'					=> 'Midgard Realms',	// This value is only used if the theme decides to use it.
	'ThemeName'					=> array('default','modern'), // Names of the themes you would like list for use in the footer. Themes are in FLUX_ROOT/themes.
	...
	'ReCaptchaPublicKey'		=> '6LcaqVMrAAAAAI62Mas2M_T7yblbLzOtsecnM4VE',					// This is your reCAPTCHA public key [REQUIRED FOR RECAPTCHA] (sign up at http://www.google.com/recaptcha)
	'ReCaptchaPrivateKey'		=> '6LcaqVMrAAAAAMP8AF8pWCyK_hzpT3R0qYzY4nYY',					// This is your reCAPTCHA private key [REQUIRED FOR RECAPTCHA] (sign up at http://www.google.com/recaptcha)
	...
	'MinDonationAmount'			=> 10,						// Minimum donation amount. (NOTE: Actual donations made that are less than this account won't be exchanged)
	...
	'PayPalBusinessEmail'		=> 'felipe_cenarios@hotmail.com',		// Enter the e-mail under which you have registered your business account.
	...
	'MercadoPagoAccessToken' => 'TEST-6037259126390243-051915-ba5a5bf14290d856db18e03914a61f7d-1224889202', //token do mercado comprove sua identidade
	'MinDonationAmount' => 10, //valor minimo para os donations
	'DonationCreditRate' => 1000, //1 real = 1000
...
// News Options
	...
	'CMSNewsLimit'				=> 30,						// Number of news items to display
...
// Discord Webhooks
	...
	'TinyMCEKey'				=> 'y52pvvm5c6t3aqprr5snvu90u4s51bf20vjen7tp77ytwi8b',				// Register for a key at https://www.tiny.cloud/my-account/dashboard/
