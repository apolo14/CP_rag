...
class Flux {
	...
	//funcao criada pelo deepseeekkkekek
public static function getServerStatus() {
    $status = array();
    foreach (self::$loginAthenaGroupRegistry as $groupName => $loginAthenaGroup) {
        $status[$groupName] = array();
